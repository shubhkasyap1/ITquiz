...
const Login = () => {
  return (
    <div className="section-none container min-h-screen flex flex-col bg-gradient-to-br from-start via-middle to-end text-white relative overflow-hidden items-center px-0 bg-cover bg-no-repeat w-screen bg-center h-screen">
      ...
      <div className="flex flex-row w-full max-w-6xl gap-10 mx-auto items-center justify-between px-6">
