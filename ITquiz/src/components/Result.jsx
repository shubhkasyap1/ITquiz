...
const Result = () => {
  ...
  return (
    <div className="p-6 bg-gray-100 min-h-screen">
      <h2 className="text-2xl font-bold mb-4 text-center text-gray-800">Quiz Results</h2>
              ...
              {students.length > 0 ? (
                students.map((student, index) => (
                  <tr key={student.erpId} className="text-center text-gray-800">
                    ...
                    <td className="border border-gray-400 px-4 py-2 font-semibold">{student.marks}</td>
                  </tr>
                ))
              ) : (
                <tr>
