...
export const StudentInstruction = () => {
  ...
  return (
    <div className="p-6 bg-white rounded-lg shadow-md max-w-4xl mx-auto ">
      ...
      <div className="max-h-96 overflow-y-auto p-4 border rounded-lg shadow-sm [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-track]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-50 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-gray-200 hover:[&::-webkit-scrollbar-thumb]:bg-gray-300">
